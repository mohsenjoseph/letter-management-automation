...
<section id="main-content">
    <section class="wrapper" style="width:95%;">
        ...
        <form action="<?= URL; ?>letter/eprintLetterDabir" name="formLetter" id="formLetter" method="post" enctype="multipart/form-data" >
            <input type="hidden" value="<?= $letter['id']; ?>"  name="letterId"   >
            <input type="hidden" value="<?= $itemBox; ?>"  name="itemBox"   >
            <input type="hidden" value="<?= $levelActive; ?>"  name="levelId"   >
            <input type="hidden" value="<?= $activemenu; ?>"  name="activemenu"   >
            ...
            <div class="col-lg-3 col-md-3 right" >
                <select disabled autocomplete="off" id="signature" name="signature"   class="w3-input  col-lg-12 right">
                    <option>انتخاب کنید</option>
                    <?php
                    foreach ($levelAvailable as $level) {
                        ?>
                        <option <?php if($letter['levelId_signature']==$level['id'])
                        {
                            echo "selected";
                            $display='inline';
                            $signature_level=$letter['levelId_signature'];
                ...
                ?>
                <span  class="span_item_signature" id="span_item_signature" style="display:none"> <?= $signature_description;?>
                    <input type="hidden" value="<?=$signature_level;?>"  name="date_signature" id="date_signature" >
                ...
                <div class="col-lg-3 col-md-3 right" >
                    <select disabled autocomplete="off" name="dabirkhone" id="dabirkhone" class="w3-input  col-lg-12 right">
                        <option>انتخاب کنید</option>
                        <?php
                ...
                <ul class="nav top-menu ">
                    <li  id="showListRecive" class="dropdown" >
                        <input disabled type="text" id="strRecive" data-toggle="" onkeyup="dropdownListRecive(this,this.value)"
                               class="right col-lg-3 w3-input " style="display: inline">
            ...
            <div class="col-lg-4 col-md-4 right">
                <ul class="nav top-menu ">
                    <li  id="showListCc" class="dropdown" >
                        <input disabled type="text" id="strCc" data-toggle="" onkeyup="dropdownListCc(this,this.value)"
                               class="right  col-lg-3 w3-input " style="display: inline">
        ...
        <div class="row "style="padding: 5px">
            <div class="col-lg-5 col-md-5 ">
                <input  disabled name="subject" value="<?= @$letter['subject'];?>" placeholder="عنوان نامه" required class="w3-input   col-lg-12   right">
            </div>
            <div class="col-lg-5 col-md-5 right">
                <input disabled name="description" value="<?= @$letter['description'];?>"  placeholder="فرستنده نامه" class="w3-input  col-lg-12  right"  >
            </div>
            <div class="col-lg-2 col-md-2 right">
                سایز برگه چاپ:
        ...
        <div class="row center " style="padding: 10px">
           <?php /*?> <a  name="preview" class="btn" style="background-color: #626262;color:#fff" onclick="previewLetter()" title="پیش نماش چاپ" ><i class="icon-print"></i></a><?php */?>
            ...
            <?php
            /*
            if($signature_status_user>0 && $levelActive==$signature_status_user ) {
                ?>
            ...
            ?>
            <button  name="save" class="btn btn-info"> <i class="icon-edit"   ></i> ذخیره      </button>
        ...
        <script>
            ...
            function letterSend(){
                ...
                if(recive=='انتخاب کنید' ){ alert("گیرنده نامه تعیین نشده است"); return }
